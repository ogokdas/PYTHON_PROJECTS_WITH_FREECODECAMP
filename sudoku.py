# A pip script created by MorvanZhou, that generates Sudoku puzzle
# Firstly, I added 'sudokum' package to my project. In Settings, Python interpreters, add ...
import sudokum
g = sudokum.generate(mask_rate=0.5)
for list in g:
    print(list)

# Here, I changed the values 0 to -1 to adapt my program.
for i in range(9):
    for j in range(9):
        if g[i][j] == 0:
            g[i][j] = -1

# pprint is a module that makes outputs readable ..
